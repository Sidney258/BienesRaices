<x-layout>
    <div class="w-full shadow max-w-md mx-auto mt-10">
        <h2 class="text-4xl font-bold my-6 text-center">Login</h2>
        <form action="{{ route('login.authenticate') }}" method="POST" class="bg-white rounded px-8 pt-6 pb-8 mb-4">
            ...
            <div class="flex items-center justify-between">
                <button type="submit" class="bg-black text-white cursor-pointer py-2 px-4 focus:outline-none">
                    Login
                </button>
            </div>
            <div>
                <p class="text-black text-sm mt-5">Nao tem uma conta <a class="text-blue-400 underline"
